...
class RobotBridgePackageTest(TestCase):
  ...
  def test_sorting_world_has_three_reachable_instances_per_retained_class(self) -> None:
    ...
    self.assertEqual(
      ...
      [
        "0.1625 -0.220 0.320 0 1.570796 0",
        "0.2625 -0.220 0.320 0 1.570796 0",
        "0.3625 -0.220 0.320 0 1.570796 0",
      ],
    )
    self.assertEqual(
      [part_poses[f"metal_hex_nut_{index:02d}"] for index in range(1, 4)],
      [
        "0.1625 -0.130 0.3125 0 0 -0.261799",
        "0.2625 -0.130 0.3125 0 0 0",
        "0.3625 -0.130 0.3125 0 0 0.261799",
      ],
    )
    bolt_poses = [
    ...
    self.assertEqual(
      bolt_poses,
      [
        "0.1625 -0.040 0.3325 3.141593 0 0",
        "0.2625 -0.040 0.3325 3.141593 0 0",
        "0.3625 -0.040 0.3325 3.141593 0 0",
      ],
    )
