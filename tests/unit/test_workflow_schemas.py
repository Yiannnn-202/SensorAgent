...
class WorkflowSchemaTest(TestCase):
  def test_action_step_schema(self) -> None:
    ...
    self.assertEqual(step.target, "vision.mock_detect")
  ...
  def test_action_list_schema(self) -> None:
    actionlist = ActionList(
      name="mock.pick_place",
      description="Mock pick-and-place action list.",
    ...
    self.assertEqual(actionlist.name, "mock.pick_place")
