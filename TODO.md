...
- [ ] Replace broad tool exception handling with typed errors.
- [ ] Replace broad skill exception handling with typed errors.
...
- [ ] Add richer `ToolError` and `SkillError` schemas.
- [ ] Add tool/skill metadata such as version, tags, and enabled state.
- [ ] Add duplicate registration tests.
- [ ] Add unknown tool/skill tests.
