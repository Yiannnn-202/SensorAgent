...
class RmArm : public rclcpp::Node {
 public:
  ...
  void Set_UDP_Configuration(int udp_cycle, int udp_port, int udp_force_coordinate,
                             std::string udp_ip, bool hand, bool rm_plus_base,
                             bool rm_plus_state);  //设置udp主动上报配置
  /*******************************运动控制回调函数******************************/
  ...
  void Arm_Emergency_Stop_Callback(
      const rm_ros_interfaces::msg::Stop::SharedPtr msg);          //设置机械臂急停状态
  ...
  /*******************************主动上报回调函数******************************/
  void Arm_Get_Realtime_Push_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //获取主动上报配置
  void Arm_Set_Realtime_Push_Callback(
      const rm_ros_interfaces::msg::Setrealtimepush::SharedPtr msg);  //设置主动上报配置参数
  /*******************************力位混合回调函数******************************/
  void Arm_Start_Force_Position_Move_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //力位混合开始
  void Arm_Stop_Force_Position_Move_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //力位混合结束
  ...
  void Arm_Stop_Force_Postion_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //结束力位混合透传
  /*******************************坐标系回调函数******************************/
  ...
  void Arm_Get_Current_Tool_Frame_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //查询工具坐标系
  void Arm_Get_All_Tool_Frame_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //查询所有工具坐标系
  void Arm_Get_All_Work_Frame_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //查询所有工作坐标系
  /*******************************设置工具端电压*********************************/
  ...
  /*********************************夹爪回调函数******************************/
  void Arm_Set_Gripper_Pick_On_Callback(
      const rm_ros_interfaces::msg::Gripperpick::SharedPtr msg);  //持续力控夹取
  void Arm_Set_Gripper_Pick_Callback(
      const rm_ros_interfaces::msg::Gripperpick::SharedPtr msg);  //力控夹取
  void Arm_Set_Gripper_Position_Callback(
      const rm_ros_interfaces::msg::Gripperset::SharedPtr msg);  //移动到固定位置
  /*********************************灵巧手回调函数******************************/
  void Arm_Set_Hand_Posture_Callback(
      const rm_ros_interfaces::msg::Handposture::SharedPtr msg);  //设置灵巧手手势
  void Arm_Set_Hand_Seq_Callback(
      const rm_ros_interfaces::msg::Handseq::SharedPtr msg);  //设置灵巧手动作序列
  void Arm_Set_Hand_Angle_Callback(
      const rm_ros_interfaces::msg::Handangle::SharedPtr msg);  //设置灵巧手角度
  void Arm_Set_Hand_Speed_Callback(
      const rm_ros_interfaces::msg::Handspeed::SharedPtr msg);  //设置灵巧手速度
  void Arm_Set_Hand_Force_Callback(
      const rm_ros_interfaces::msg::Handforce::SharedPtr msg);  //设置灵巧手力控
  void Arm_Set_Hand_Follow_Angle_Callback(
      const rm_ros_interfaces::msg::Handangle::SharedPtr msg);  //设置灵巧手角度跟随
  void Arm_Set_Hand_Follow_Pos_Callback(
      const rm_ros_interfaces::msg::Handangle::SharedPtr msg);  //设置灵巧手位置跟随
  /*********************************升降机构回调函数******************************/
  void Arm_Set_Lift_Speed_Callback(
      const rm_ros_interfaces::msg::Liftspeed::SharedPtr msg);  //升降机构速度开环控制
  void Arm_Set_Lift_Height_Callback(
      const rm_ros_interfaces::msg::Liftheight::SharedPtr msg);  //升降机构位置闭环控制
  void Arm_Get_Lift_State_Callback(const std_msgs::msg::Empty::SharedPtr msg);  //获取升降机构状态
  /*********************************拓展关节回调函数******************************/
  void Arm_Set_Expand_Speed_Callback(
      const std_msgs::msg::Int32::SharedPtr msg);  //升降机构速度开环控制
  void Arm_Set_Expand_Pos_Callback(
      const rm_ros_interfaces::msg::Expandpos::SharedPtr msg);  //升降机构位置闭环控制
  ...
  void Arm_Get_Arm_Software_Info_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //获取机械臂固件版本
  void Arm_Get_Joint_Software_Version_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //获取机械臂固件版本
  void Arm_Get_Tool_Software_Version_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //获取机械臂固件版本
  ...
  void Save_Trajectory_File_Callback(
      const std_msgs::msg::String::SharedPtr msg);  //保存轨迹到控制机器

  void Arm_Get_Flowchart_Program_Run_State_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //获取机械臂固件版本
  ...
  void Delete_Modbus_Tcp_Master_Callback(
      const rm_ros_interfaces::msg::Mastername::SharedPtr msg);  //删除Modbus TCP主站
  void Get_Modbus_Tcp_Master_Callback(
      const rm_ros_interfaces::msg::Mastername::SharedPtr msg);  //查询指定modbus主站
  void Get_Modbus_Tcp_Master_List_Callback(
      const rm_ros_interfaces::msg::Getmodbustcpmasterlist::SharedPtr msg);  //查询modbus主站列表
  void Set_Controller_RS485_Mode_Callback(const rm_ros_interfaces::msg::RS485params::SharedPtr
                                              msg);  // 设置控制器RS485模式(四代控制器支持)
  void Get_Controller_RS485_Mode_v4_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  // 查询控制器RS485模式(四代控制器支持)
  void Set_Tool_RS485_Mode_Callback(const rm_ros_interfaces::msg::RS485params::SharedPtr
                                        msg);  // 设置工具端RS485模式(四代控制器支持)
  void Get_Tool_RS485_Mode_v4_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  // 查询工具端RS485模式(四代控制器支持)
  ...
  void Read_Modbus_RTU_Input_Status_Callback(
      const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr
          msg);  // Modbus RTU协议读离散量输入
  void Read_Modbus_RTU_Holding_Registers_Callback(
      const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr
          msg);  // Modbus RTU协议读保持寄存器
  void Write_Modbus_RTU_Registers_Callback(
      const rm_ros_interfaces::msg::Modbusrtuwriteparams::SharedPtr
          msg);  // Modbus RTU协议写保持寄存器
  void Read_Modbus_RTU_Input_Registers_Callback(
      const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr
          msg);  // Modbus RTU协议读输入寄存器
  ...
  void Read_Modbus_TCP_Input_Status_Callback(
      const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr
          msg);  // Modbus TCP协议读离散量输入
  void Read_Modbus_TCP_Holding_Registers_Callback(
      const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr
          msg);  // Modbus TCP协议读保持寄存器
  void Write_Modbus_TCP_Registers_Callback(
      const rm_ros_interfaces::msg::Modbustcpwriteparams::SharedPtr
          msg);  // Modbus TCP协议写保持寄存器
  void Read_Modbus_TCP_Input_Registers_Callback(
      const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr
          msg);  // Modbus TCP协议读输入寄存器

  void Close_Controller_Tcp_Modbus_Callback(
      const std_msgs::msg::Empty::SharedPtr msg);  //关闭tcp modbus
  void Set_Controller_Tcp_Mode_Callback(
      const rm_ros_interfaces::msg::Modbustcpmasterinfo::SharedPtr msg);  //设置tcp modbus
  void Close_Controller_RS485_Modbus_Callback(
      const std_msgs::msg::UInt16::SharedPtr msg);  //关闭485 modbus

  void Send_Project_Callback(const rm_ros_interfaces::msg::Sendproject::SharedPtr msg);  //文件下发
  void Get_Program_Run_State_Callback(
 ...
 private:
  ...
  /********************************************************固件版本***************************************************/
  /*************************************************查询固件版本发布器****************************************/
  // rclcpp::Publisher<rm_ros_interfaces::msg::Armsoftversionv3>::SharedPtr
  // Get_Arm_Software_Version_Result_v3;
  // rclcpp::Publisher<rm_ros_interfaces::msg::Armsoftversionv4>::SharedPtr
  // Get_Arm_Software_Version_Result_v4;
  rclcpp::Publisher<rm_ros_interfaces::msg::Armsoftversion>::SharedPtr
  ...
  /*************************************************轨迹列表相关接口****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Trajectorylist>::SharedPtr
      Get_Trajectory_File_List_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Gettrajectorylist>::SharedPtr
  ...
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbustcpmasterinfo>::SharedPtr
      Add_Modbus_Tcp_Master_Cmd;
  /*************************************************更新Modbus
   * TCP主站****************************************/
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Update_Modbus_Tcp_Master_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbustcpmasterupdata>::SharedPtr
  ...
  /*************************************************查询指定modbus主站****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Modbustcpmasterinfo>::SharedPtr
      Get_Modbus_Tcp_Master_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Mastername>::SharedPtr Get_Modbus_Tcp_Master_Cmd;
  /*************************************************查询modbus主站列表****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Modbustcpmasterlist>::SharedPtr
      Get_Modbus_Tcp_Master_List_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Getmodbustcpmasterlist>::SharedPtr
  ...
  rclcpp::Subscription<rm_ros_interfaces::msg::RS485params>::SharedPtr
      Set_Controller_RS485_Mode_Cmd;
  /*************************************************查询控制器RS485模式(四代控制器支持)****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::RS485params>::SharedPtr
  ...
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbusrtureadparams>::SharedPtr
      Read_Modbus_RTU_Coils_Cmd;
  /*************************************************Modbus
   * RTU协议写线圈****************************************/
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Write_Modbus_RTU_Coils_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbusrtuwriteparams>::SharedPtr
      Write_Modbus_RTU_Coils_Cmd;
  /*************************************************Modbus
   * RTU协议读离散量输入****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Modbusreaddata>::SharedPtr
  ...
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbustcpreadparams>::SharedPtr
      Read_Modbus_TCP_Coils_Cmd;
  /*************************************************Modbus
   * TCP协议写线圈****************************************/
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Write_Modbus_TCP_Coils_Result;
  rclcpp::Subscription<rm_ros_interfaces::msg::Modbustcpwriteparams>::SharedPtr
  ...
  /*************************************************查询在线编程运行状态****************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Programrunstate>::SharedPtr
  ...
  /**************************************************75力位混合角度透传订阅器***************************************/
  // rclcpp::Subscription<rm_ros_interfaces::msg::Forcepositionmovejoint75>::SharedPtr
  // Force_Position_Move_Joint_75_Cmd;
  /**************************************************力位混合角度透传订阅器***************************************/
  rclcpp::Subscription<rm_ros_interfaces::msg::Forcepositionmovejoint>::SharedPtr
      Force_Position_Move_Joint_Cmd;
  /***********************************************力位混合位姿透传订阅器*********************************************/
  rclcpp::Subscription<rm_ros_interfaces::msg::Forcepositionmovepose>::SharedPtr
      Force_Position_Move_Pose_Cmd;
  /***********************************************力位混合补偿透传订阅器*********************************************/
  rclcpp::Subscription<rm_ros_interfaces::msg::Forcepositionmove>::SharedPtr
      Force_Position_Move_Cmd;
  /**********************************************************************end************************************************************/
  ...
  /**************************************获取机械臂当前状态发布器*************************************/
  rclcpp::Publisher<rm_ros_interfaces::msg::Armoriginalstate>::SharedPtr
...
class UdpPublisherNode : public rclcpp::Node {
 ...
 private:
  ...
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr
      Joint_Position_Result;  //关节当前状态发布器
  rclcpp::Publisher<geometry_msgs::msg::Pose>::SharedPtr
      Arm_Position_Result;  //末端位姿当前状态发布器
  ...
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointerrorcode>::SharedPtr
      Joint_Error_Code_Result;  //关节报错信息发布器
  ...
  rclcpp::Publisher<std_msgs::msg::UInt16>::SharedPtr
      Arm_Coordinate_Result;  //力传感器基准坐标发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Handstatus>::SharedPtr
      Hand_Status_Result;  //灵巧手数据发布器
  ...
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointcurrent>::SharedPtr
      Joint_Current_Result;  //关节当前电流发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointenflag>::SharedPtr
      Joint_En_Flag_Result;  //关节使能状态布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointposeeuler>::SharedPtr
      Joint_Pose_Euler_Result;  //末端位姿欧拉角形式发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointspeed>::SharedPtr
      Joint_Speed_Result;  //关节速度发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointtemperature>::SharedPtr
      Joint_Temperature_Result;  //关节温度发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Jointvoltage>::SharedPtr
      Joint_Voltage_Result;  //关节电压发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Udpliftstate>::SharedPtr
      Lift_State_Result;  //升降关节发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Udpexpandstate>::SharedPtr
      Expand_State_Result;  //拓展关节发布器
  rclcpp::Publisher<rm_ros_interfaces::msg::Alohastate>::SharedPtr
      Aloha_State_Result;  // aloha状态发布器
