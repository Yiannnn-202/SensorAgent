...
class RM_Service {
 public:
   ...
   */
  RM_INTERFACE_EXPORT void rm_set_log_call_back(void (*LogCallback)(const char *message,
                                                                    va_list args),
                                                int level);
   ...
   * 必须先将关节掉使能，否则会设置不成功。
   * 关节所有参数在修改完成后，会自动保存到关节
   * Flash，立即生效，之后关节处于掉使能状态，修改完参数后必须 发送指令控制关节上使能。
   * @attention
   * 睿尔曼机械臂在出厂前所有参数都已经配置到最佳状态，一般不建议用户修改关节的底层参数。若用户确需修改，首先
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_max_speed(rm_robot_handle *handle, int joint_num,
                                                 float max_speed);
  /**
   * @brief 设置关节最大加速度
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_max_acc(rm_robot_handle *handle, int joint_num,
                                               float max_acc);
  /**
   * @brief 设置关节最小限位
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_min_pos(rm_robot_handle *handle, int joint_num,
                                               float min_pos);
  /**
   * @brief 设置关节最大限位
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_max_pos(rm_robot_handle *handle, int joint_num,
                                               float max_pos);
  /**
   * @brief 设置关节最大速度(驱动器)
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_drive_max_speed(rm_robot_handle *handle, int joint_num,
                                                       float max_speed);
  /**
   * @brief 设置关节最大加速度(驱动器)
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_drive_max_acc(rm_robot_handle *handle, int joint_num,
                                                     float max_acc);
  /**
   * @brief 设置关节最小限位(驱动器)
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_drive_min_pos(rm_robot_handle *handle, int joint_num,
                                                     float min_pos);
  /**
   * @brief 设置关节最大限位(驱动器)
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_drive_max_pos(rm_robot_handle *handle, int joint_num,
                                                     float max_pos);
  /**
   * @brief 设置关节使能状态
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_en_state(rm_robot_handle *handle, int joint_num,
                                                int en_state);
  /**
   * @brief 设置关节零位
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_joint_err_flag(rm_robot_handle *handle, uint16_t *err_flag,
                                                uint16_t *brake_state);
  /** @} */  // 结束关节配置组的定义
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_generate_auto_tool_frame(rm_robot_handle *handle, const char *name,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_total_tool_frame(rm_robot_handle *handle,
                                                  rm_frame_name_t *frame_names, int *len);
  /**
   * @brief  获取指定工具坐标系
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_given_tool_frame(rm_robot_handle *handle, const char *name,
                                                  rm_frame_t *frame);
  /**
   * @brief 获取当前工具坐标系
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_current_tool_frame(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_tool_envelope(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_auto_work_frame(rm_robot_handle *handle, const char *workname,
                                                 int point_num);
  /**
   * @brief 手动设置工作坐标系
   *
   ...
   * @return  int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_manual_work_frame(rm_robot_handle *handle, const char *work_name,
                                                   rm_pose_t pose);
  /**
   * @brief 切换当前工作坐标系
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_update_work_frame(rm_robot_handle *handle, const char *work_name,
                                               rm_pose_t pose);
  /**
   * @brief 获取所有工作坐标系名称
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_total_work_frame(rm_robot_handle *handle,
                                                  rm_frame_name_t *frame_names, int *len);
  /**
   * @brief 获取指定工作坐标系
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_given_work_frame(rm_robot_handle *handle, const char *name,
                                                  rm_pose_t *pose);
  /**
   * @brief 获取当前工作坐标系
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_current_work_frame(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_current_arm_state(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_current_joint_temperature(rm_robot_handle *handle,
                                                           float *temperature);
  /**
   * @brief 获取关节当前电流
   *
   ...
   */
  RM_INTERFACE_EXPORT int rm_movej(rm_robot_handle *handle, const float *joint, int v, int r,
   ...
   * @return int 函数执行的状态码。
              ...
              - -6: 机械臂停止运动规划，外部发送了停止运动指令。
   */
  RM_INTERFACE_EXPORT int rm_movel(rm_robot_handle *handle, rm_pose_t pose, int v, int r,
                                   int trajectory_connect, int block);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -7: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_movel_offset(rm_robot_handle *handle, rm_pose_t offset, int v, int r,
                                          int trajectory_connect, int frame_type, int block);
  /**
   * @brief 样条曲线运动
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -6: 机械臂停止运动规划，外部发送了停止运动指令。
   */
  RM_INTERFACE_EXPORT int rm_moves(rm_robot_handle *handle, rm_pose_t pose, int v, int r,
                                   int trajectory_connect, int block);
  /**
   * @brief 笛卡尔空间圆弧运动
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -6: 机械臂停止运动规划，外部发送了停止运动指令。
   */
  RM_INTERFACE_EXPORT int rm_movec(rm_robot_handle *handle, rm_pose_t pose_via, rm_pose_t pose_to,
                                   int v, int r, int loop, int trajectory_connect, int block);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -6: 机械臂停止运动规划，外部发送了停止运动指令。
   */
  RM_INTERFACE_EXPORT int rm_movej_p(rm_robot_handle *handle, rm_pose_t pose, int v, int r,
                                     int trajectory_connect, int block);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -1: 数据发送失败，通信过程中出现问题。
   */
  RM_INTERFACE_EXPORT int rm_movej_canfd(rm_robot_handle *handle, float *joint, bool follow,
                                         int expand, int trajectory_mode = 0, int radio = 0);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_arm_current_trajectory(rm_robot_handle *handle,
                                                        rm_arm_current_trajectory_e *type,
                                                        float *data);
  /** @} */  // 结束组的定义
   ...
   * @return int 函数执行的状态码。
              ...
              - -5: 单线程模式超时未接收到返回，请确保超时时间设置合理。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_step(rm_robot_handle *handle, int joint_num, float step,
                                            int v, int block);
  /**
   * @brief 当前工作坐标系下，位置步进
   *
   ...
   */
  RM_INTERFACE_EXPORT int rm_set_pos_step(rm_robot_handle *handle, rm_pos_teach_type_e type,
                                          float step, int v, int block);
  /**
   * @brief 当前工作坐标系下，姿态步进
   *
   * @param handle 机械臂控制句柄
   ...
   * @attention 参考坐标系默认为当前工作坐标系，可调用rm_set_teach_frame修改为工具坐标系，
   */
  RM_INTERFACE_EXPORT int rm_set_ort_step(rm_robot_handle *handle, rm_ort_teach_type_e type,
                                          float step, int v, int block);
  /**
   * @brief 切换示教运动坐标系
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_joint_teach(rm_robot_handle *handle, int joint_num, int direction,
                                             int v);
  /**
   ...
   * @attention 参考坐标系默认为当前工作坐标系，可调用rm_set_teach_frame修改为工具坐标系，
   */
  RM_INTERFACE_EXPORT int rm_set_pos_teach(rm_robot_handle *handle, rm_pos_teach_type_e type,
                                           int direction, int v);
  /**
   ...
   * @attention 参考坐标系默认为当前工作坐标系，可调用rm_set_teach_frame修改为工具坐标系，
   */
  RM_INTERFACE_EXPORT int rm_set_ort_teach(rm_robot_handle *handle, rm_ort_teach_type_e type,
                                           int direction, int v);
  /**
   * @brief 示教停止
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_controller_state(rm_robot_handle *handle, float *voltage,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_system_runtime(rm_robot_handle *handle, int *day, int *hour,
                                                int *min, int *sec);
  /**
   * @brief 清零控制器的累计运行时间
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_NetIP(rm_robot_handle *handle, const char *ip, const char *netmask,
                                       const char *gw);
  /**
   * @brief 清除系统错误
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_arm_software_info(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持此接口
   */
  RM_INTERFACE_EXPORT int rm_get_controller_RS485_mode(rm_robot_handle *handle, int *mode,
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持此接口
   */
  RM_INTERFACE_EXPORT int rm_get_tool_RS485_mode(rm_robot_handle *handle, int *mode, int *baudrate,
                                                 int *timeout);
  /**
   * @brief 查询关节软件版本号
   *
   * @param handle 机械臂控制句柄
   * @param version
   获取到的各关节软件版本号数组，需转换为十六进制，例如获取某关节版本为54536，转换为十六进制为D508，则当前关节的版本号为
   Vd5.0.8（三代控制器）
   ...
   * @param handle 机械臂控制句柄
   * @param version
   （三代控制器）获取到的末端接口板软件版本号,需转换为十六进制，例如获取到版本号393，转换为十六进制为189，则当前关节的版本号为
   V1.8.9
   ...
   *
   * 机械臂控制器可通过网口、WIFI、RS232-USB 接口和 RS485
   * 接口与用户通信，用户使用时无需切换，可使用上述任一接口，
   ...
   */
  RM_INTERFACE_EXPORT int rm_set_wifi_ap(rm_robot_handle *handle, const char *wifi_name,
                                         const char *password);
  /**
   * @brief 配置WiFi STA模式
   *
   ...
   */
  RM_INTERFACE_EXPORT int rm_set_wifi_sta(rm_robot_handle *handle, const char *router_name,
                                          const char *password);
   ...
   * @param handle 机械臂控制句柄
   * @param baudrate
   波特率：9600,19200,38400,115200和460800，若用户设置其他数据，控制器会默认按照460800处理。
   * @return int 函数执行的状态码。
              - 0: 成功。
              - -1: 数据发送失败，通信过程中出现问题。
              - -2: 四代控制器不支持该接口
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_wired_net(rm_robot_handle *handle, char *ip, char *mask,
                                           char *mac);
  /**
   * @brief 查询无线网卡网络信息
   *
  ...
  RM_INTERFACE_EXPORT int rm_set_IO_mode(rm_robot_handle *handle, int io_num, int io_mode,
                                         int io_speed_mode = 0, int io_speed = 0);
  /**
   * @brief 设置数字IO输出
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_IO_state(rm_robot_handle *handle, int io_num, int *state,
                                          int *mode, int *io_speed_mode = nullptr,
                                          int *io_speed = nullptr);
  /**
   * @brief 获取所有 IO 输入状态
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_gripper_route(rm_robot_handle *handle, int min_limit,
                                               int max_limit);
  /**
   ...
   * @param block true 表示阻塞模式，等待控制器返回夹爪到位指令；false
   表示非阻塞模式，不接收夹爪到位指令；
   ...
   * @return int 函数执行的状态码。
              ...
              - -4:超时
   */
  RM_INTERFACE_EXPORT int rm_set_gripper_release(rm_robot_handle *handle, int speed, bool block,
                                                 int timeout);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -4:超时
   */
  RM_INTERFACE_EXPORT int rm_set_gripper_pick(rm_robot_handle *handle, int speed, int force,
   ...
   * @return int 函数执行的状态码。
              ...
              - -4:超时
   */
  RM_INTERFACE_EXPORT int rm_set_gripper_pick_on(rm_robot_handle *handle, int speed, int force,
                                                 bool block, int timeout);
  /**
   * @brief 设置手爪达到指定位置
   * @details
   手爪到达指定位置，当当前开口小于指定开口时，手爪以指定速度松开到指定开口位置；当当前开口大于指定开口时，
   ...
   * @return int 函数执行的状态码。
              ...
              - -4:超时
   */
  RM_INTERFACE_EXPORT int rm_set_gripper_position(rm_robot_handle *handle, int position, bool block,
                                                  int timeout);
  /**
   * @brief 查询夹爪状态
   *
   ...
   * 获取六维力数据。如下图所示，正上方为六维力的 Z 轴，航插反方向为六维力的 Y
   * 轴，坐标系符合右手定则。 机械臂位于零位姿态时，工具坐标系与六维力的坐标系方向一致。
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_manual_set_force(rm_robot_handle *handle, int count, float *joint,
                                              bool block);
  /**
   * @brief 停止标定力传感器重心
   ...
   * @brief 手动标定一维力数据
   * @details
   设置一维力重心参数，一维力重新安装后，必须重新计算一维力所受到的初始力和重心。该手动标定流程，
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_manual_set_Fz(rm_robot_handle *handle, float *joint1, float *joint2,
                                           bool block);
  /** @} */  // 结束组的定义
   ...
   */
  RM_INTERFACE_EXPORT int rm_start_multi_drag_teach(rm_robot_handle *handle, int mode,
                                                    int singular_wall);
  /**
   ...
   * @note 失败的可能原因:
              ...
              - 使用六维力模式拖动示教时，当前已处于奇异区
   */
  RM_INTERFACE_EXPORT int rm_start_multi_drag_teach(rm_robot_handle *handle,
                                                    rm_multi_drag_teach_t teach_state);
  /**
   * @brief 设置电流环拖动示教灵敏度
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              - 0: 成功。
              - 1:
   控制器返回false，传递参数错误或机械臂状态发生错误，请确保机械臂当前位置为拖动示教起点。
              - -1: 数据发送失败，通信过程中出现问题。
              - -2: 数据接收失败，通信过程中出现问题或者控制器超时没有返回。
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
              - -4: 当前到位设备校验失败，即当前到位设备不为关节。
   ...
   * @param direction
   力控方向；0-沿X轴；1-沿Y轴；2-沿Z轴；3-沿RX姿态方向；4-沿RY姿态方向；5-沿RZ姿态方向
   * @param N 力的大小，单位N
   * @return int 函数执行的状态码。
              - 0: 成功。
              - 1: 控制器返回false，传递参数错误或机械臂状态发生错误。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_force_position(rm_robot_handle *handle, int sensor, int mode,
                                                int direction, float N);
  /**
   * @brief 力位混合控制-新参数
   * @details
   在笛卡尔空间轨迹规划时，使用该功能可保证机械臂末端接触力恒定，使用时力的方向与机械臂运动方向不能在同一方向。
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 超时未返回
   */
  RM_INTERFACE_EXPORT int rm_set_hand_posture(rm_robot_handle *handle, int posture_num, bool block,
                                              int timeout);
  /**
   * @brief 设置灵巧手目标手势序列号
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 超时未返回
   */
  RM_INTERFACE_EXPORT int rm_set_hand_seq(rm_robot_handle *handle, int seq_num, bool block,
                                          int timeout);
  /**
   * @brief 设置灵巧手各自由度角度
   * @details
   ...
   * @brief 设置灵巧手各自由度跟随角度
   * @details
   设置灵巧手跟随角度，灵巧手有6个自由度，从1~6分别为小拇指，无名指，中指，食指，大拇指弯曲，大拇指旋转
   * @param handle 机械臂控制句柄
   * @param hand_angle
   ...
   * @param handle 机械臂控制句柄
   * @param hand_pos
   手指位置数组，最大范围为0-65535，按照灵巧手厂商定义的角度做控制，例如因时的范围为0-1000
   * @param block 0：表示非阻塞模式，发送成功后返回，1：表示阻塞模式，接收设置成功指令后返回。
   * @return int 函数执行的状态码。
              - 0: 成功。
              - 1: 控制器返回false，传递参数错误或机械臂状态发生错误。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_hand_follow_pos(rm_robot_handle *handle, const int *hand_pos,
                                                 bool block);
  /**
   * @brief 设置灵巧手速度
   *
   ...
   *
   * 睿尔曼机械臂在控制器和末端接口板上各提供一个RS485通讯接口，这些接口可通过JSON协议配置为标准的Modbus
   * RTU模式。 在Modbus RTU模式下，用户可通过JSON协议对连接在端口上的外设进行读写操作。
   *
   * @attention
   * - 控制器的RS485接口在未配置为Modbus RTU模式时，可用于直接控制机械臂。
   * - Modbus RTU模式与机械臂控制模式不兼容。若需恢复机械臂控制模式，必须关闭该端口的Modbus
   * RTU模式。
   * - 关闭Modbus
   * RTU模式后，系统将自动切换回机械臂控制模式，使用波特率460800BPS，停止位1，数据位8，无校验。
   *
   ...
   * @param handle 机械臂控制句柄
   * @param port
   通讯端口，0-控制器RS485端口为RTU主站，1-末端接口板RS485接口为RTU主站，2-控制器RS485端口为RTU从站
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_set_modbus_mode(rm_robot_handle *handle, int port, int baudrate,
                                             int timeout);
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_set_modbustcp_mode(rm_robot_handle *handle, const char *ip, int port,
                                                int timeout);
  /**
   ...
   *
   * @param handle 机械臂控制句柄
   * @param params 线圈读取参数结构体，该指令最多一次性支持读 8
   个线圈数据，即返回的数据不会超过一个字节
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_coils(rm_robot_handle *handle,
                                        rm_peripheral_read_write_params_t params, int *data);
  /**
   * @brief 读离散量输入
   *
   * @param handle 机械臂控制句柄
   * @param params 离散量输入读取参数结构体，该指令最多一次性支持读 8
   个离散量数据，即返回的数据不会超过一个字节
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_input_status(rm_robot_handle *handle,
                                               rm_peripheral_read_write_params_t params, int *data);
  /**
   * @brief 读保持寄存器
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_holding_registers(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_input_registers(rm_robot_handle *handle,
                                                  rm_peripheral_read_write_params_t params,
                                                  int *data);
  /**
   * @brief 写单圈数据
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_single_coil(rm_robot_handle *handle,
                                               rm_peripheral_read_write_params_t params, int data);
  /**
   * @brief 写单个寄存器
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_single_register(rm_robot_handle *handle,
                                                   rm_peripheral_read_write_params_t params,
                                                   int data);
  /**
   * @brief 写多个寄存器
   ...
   * @param handle 机械臂控制句柄
   * @param params
   多个寄存器数据写入参数结构体。其中寄存器每次写的数量不超过10个，即该结构体成员num<=10。
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_registers(rm_robot_handle *handle,
                                             rm_peripheral_read_write_params_t params, int *data);
  /**
   * @brief 写多圈数据
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_coils(rm_robot_handle *handle,
                                         rm_peripheral_read_write_params_t params, int *data);
  /**
   * @brief 读多圈数据
   *
   * @param handle 机械臂控制句柄
   * @param params 多圈数据读取参数结构体，要读的线圈的数量 8< num <= 120，该指令最多一次性支持读
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_multiple_coils(rm_robot_handle *handle,
                                                 rm_peripheral_read_write_params_t params,
                                                 int *data);
  /**
   * @brief 读多个保存寄存器
   *
   * @param handle 机械臂控制句柄
   * @param params 多个保存寄存器读取参数结构体，要读的寄存器的数量 2 < num <
   13，该指令最多一次性支持读 12 个寄存器数据， 即 24 个 byte
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_multiple_holding_registers(
      rm_robot_handle *handle, rm_peripheral_read_write_params_t params, int *data);
  /**
   * @brief 读多个输入寄存器
   *
   * @param handle 机械臂控制句柄
   * @param params 多个输入寄存器读取参数结构体，要读的寄存器的数量 2 < num <
   13，该指令最多一次性支持读 12 个寄存器数据， 即 24 个 byte
   * @param data 返回寄存器数据，数据类型：int8
   * @return int 函数执行的状态码。
              - 0: 成功。
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_install_pose(rm_robot_handle *handle, float *x, float *y,
                                              float *z);
  /** @} */  // 结束组的定义
   ...
   * 平滑程度决定了机械臂的运行状态。基础系列 WIFI 和网口模式透传周期最快 20ms，USB 和 RS485
   * 模式透传周期最快 10ms。 高速网口的透传周期最快也可到
   * 10ms，不过在使用该高速网口前，需要使用指令打开配置。另外 I 系列有线网口周期最快可达 2ms。
   * @{
   */
  /**
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_force_position_move_joint(rm_robot_handle *handle, const float *joint,
                                                       int sensor, int mode, int dir, float force,
                                                       bool follow);
  /**
   * @brief 透传力位混合补偿-位姿方式
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_force_position_move_pose(rm_robot_handle *handle, rm_pose_t pose,
                                                      int sensor, int mode, int dir, float force,
                                                      bool follow);
  /**
   * @brief 透传力位混合补偿-新参数
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_force_position_move(rm_robot_handle *handle,
                                                 rm_force_position_move_t param);
  /** @} */  // 结束组的定义
   ...
   * @return int 函数执行的状态码。
              ...
              - -5: 单线程模式超时未接收到返回，请确保超时时间设置合理。
   */
  RM_INTERFACE_EXPORT int rm_set_lift_height(rm_robot_handle *handle, int speed, int height,
                                             int block);
  /**
   * @brief 获取升降机构状态
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -6: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_send_project(rm_robot_handle *handle, rm_send_project_t project,
                                          int *errline);
  /**
   * @brief 规划过程中改变速度系数
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_program_trajectory_list(rm_robot_handle *handle, int page_num,
                                                         int page_size, const char *vague_search,
   ...
   */
  RM_INTERFACE_EXPORT int rm_set_program_id_run(rm_robot_handle *handle, int id, int speed,
                                                int block);
  /**
   * @brief 查询在线编程运行状态
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 四代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_program_run_state(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_flowchart_program_run_state(rm_robot_handle *handle,
                                                             rm_flowchart_run_state_t *run_state);
  /**
   * @brief 删除指定编号编程文件
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_update_program_trajectory(rm_robot_handle *handle, int id, int speed,
                                                       const char *name);
  /**
   * @brief 设置 IO 默认运行编号
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_update_global_waypoint(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_delete_global_waypoint(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_given_global_waypoint(rm_robot_handle *handle, const char *name,
                                                       rm_waypoint_t *point);
  /**
   * @brief 查询多个全局路点
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_global_waypoints_list(rm_robot_handle *handle, int page_num,
                                                       int page_size, const char *vague_search,
   ...
   *
   * 睿尔曼机械臂提供 UDP
   * 机械臂状态主动上报接口，使用时，需要和机械臂处于同一局域网络下，通过设置主动上报配置接口的目标
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_realtime_push(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_realtime_push(rm_robot_handle *handle,
                                               rm_realtime_push_config_t *config);
  /** @} */  // 结束组的定义
   ...
   *
   * I
   * 系列机械臂具备电子围栏与虚拟墙功能，并提供了针对控制器所保存的电子围栏或虚拟墙几何模型参数的操作接口。
   ...
   */
  RM_INTERFACE_EXPORT int rm_add_electronic_fence_config(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_update_electronic_fence_config(rm_robot_handle *handle,
                                                            rm_fence_config_t config);
  /**
   * @brief 删除指定几何模型
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_delete_electronic_fence_config(rm_robot_handle *handle,
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_electronic_fence_list_names(rm_robot_handle *handle,
                                                             rm_fence_names_t *names, int *len);
  /**
   * @brief 查询指定几何模型参数
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_given_electronic_fence_config(rm_robot_handle *handle,
                                                               const char *name,
                                                               rm_fence_config_t *config);
  /**
   * @brief 查询所有几何模型参数
  ...
  RM_INTERFACE_EXPORT int rm_get_electronic_fence_list_infos(rm_robot_handle *handle,
                                                             rm_fence_config_list_t *config_list,
                                                             int *len);
  /**
   * @brief 设置电子围栏使能状态
   *
   ...
   */
  RM_INTERFACE_EXPORT int rm_set_electronic_fence_enable(rm_robot_handle *handle,
                                                         rm_electronic_fence_enable_t state);
  /**
   * @brief 获取电子围栏使能状态
   *
   * @param handle 机械臂控制句柄
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_electronic_fence_enable(rm_robot_handle *handle,
                                                         rm_electronic_fence_enable_t *state);
  /**
   * @brief 设置当前电子围栏参数配置
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_electronic_fence_config(rm_robot_handle *handle,
                                                         rm_fence_config_t config);
  /**
   * @brief 获取当前电子围栏参数
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_electronic_fence_config(rm_robot_handle *handle,
                                                         rm_fence_config_t *config);
  /**
   * @brief 设置虚拟墙使能状态
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_virtual_wall_enable(rm_robot_handle *handle,
                                                     rm_electronic_fence_enable_t state);
  /**
   * @brief 获取虚拟墙使能状态
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_virtual_wall_enable(rm_robot_handle *handle,
                                                     rm_electronic_fence_enable_t *state);
  /**
   * @brief 设置当前虚拟墙参数
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_virtual_wall_config(rm_robot_handle *handle,
                                                     rm_fence_config_t config);
  /**
   * @brief 获取当前虚拟墙参数
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_virtual_wall_config(rm_robot_handle *handle,
                                                     rm_fence_config_t *config);
  ...
  */
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
  */
  RM_INTERFACE_EXPORT int rm_get_rm_plus_base_info(rm_robot_handle *handle,
                                                   rm_plus_base_info_t *info);
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
  */
  RM_INTERFACE_EXPORT int rm_get_rm_plus_state_info(rm_robot_handle *handle,
                                                    rm_plus_state_info_t *info);
  ...
  */
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
  */
  RM_INTERFACE_EXPORT int rm_get_collision_remove_enable(rm_robot_handle *handle,
                                                         bool *enable_state);
   ...
   * @brief 初始化算法依赖数据(不连接机械臂时调用)
   * @details
   * 初始化算法依赖数据，根据给定的DH参数判断机械臂类型，适用于通用型机械臂（RM_MODEL_UNIVERSAL_E）。
   *
   * @param sensor_type 传感器型号
   * @param dh DH参数
   * @param dof 自由度
   */
  RM_INTERFACE_EXPORT void rm_algo_init_sys_data_by_dh(rm_force_type_e sensor_type, rm_dh_t dh,
                                                       int dof);
  /**
   * @brief 设置算法机械臂自由度
   ...
   *
   * @param weight
   * 为一个数组,元素个数为6,分别对应末端位姿的x,y,z,,rx,ry,rz,取值为0~1,权重越大对应的位姿到达精确度越高,反之则相反
   */
   ...
   *
   * @param dq_weight
   * 为一个数组,元素个数为自由度个数,为本身关节的最大限速乘以权重,取值为0~1,权重越大则跟踪效果越好
   */
   ...
   *
   * @param enable 0: 关闭限位保持  1: 开启限位保持 若客户不调用此接口则默认为0即关闭限位保持功能,
   * 当调用ik_remote_init时自动初始化为0
   */
   ...
   * @param joint     [in]     要设置的关节 (JOINT_Q3 或
   * JOINT_Q4；七轴支持设置关节3和关节4，六轴仅支持关节3)
   ...
   *          0: 成功
   */
  RM_INTERFACE_EXPORT int rm_algo_set_joint_limit_angle(rm_dofType_e dof_type, rm_jointType_e joint,
                                                        rm_limitType_e limit, float angle);
  /**
   ...
   */
  RM_INTERFACE_EXPORT int rm_algo_ik_remote(const rm_Mat_t rm_T06d, float *const q_in,
                                            float *q_out);
  /**
   * @brief
   *逆解函数，默认遍历模式，可使用Algo_Set_Redundant_Parameter_Traversal_Mode接口设置逆解求解模式
   *
   * @param handle 机械臂控制句柄
   ...
   */
  RM_INTERFACE_EXPORT int rm_algo_inverse_kinematics(rm_robot_handle *handle,
   ...
   */
  RM_INTERFACE_EXPORT int rm_algo_ikine_select_ik_solve(float *weight,
                                                        rm_inverse_kinematics_all_solve_t params);

  /**
   * @brief 检查逆解结果是否超出关节限位(当前仅支持六自由度机器人)
   * @param q_solve 选解，单位：°
   * @return int 0:未超限位,1~dof:
   * 第i个关节超限位,-1：当前机器人非六自由度，当前仅支持六自由度机器人
   */
   ...
   * @return int 0:表示未超限 i:表示关节i超限，优先报序号小的关节
   * -1：当前机器人非六自由度，当前仅支持六自由度机器人
   */
  RM_INTERFACE_EXPORT int rm_algo_ikine_check_joint_velocity_limit(float dt,
                                                                   const float *const q_ref,
   ...
   *      -2: q_ref 输入参数非法
   */
  RM_INTERFACE_EXPORT int rm_algo_calculate_arm_angle_from_config_rm75(float *q_ref,
                                                                       float *arm_angle);
   ...
   *              -3: 机型非RM75
   */
  RM_INTERFACE_EXPORT int rm_algo_inverse_kinematics_rm75_for_arm_angle(
      rm_inverse_kinematics_params_t params, float arm_angle, float *q_solve);
   ...
   *            -2:表示计算失败
   */
  RM_INTERFACE_EXPORT int rm_algo_universal_singularity_analyse(const float *const q,
                                                                float singluar_value_limit);
  /**
   * @brief
   * 恢复初始阈值(仅适用于解析法分析机器人奇异状态)，阈值初始化为：limit_qe=10deg,limit_qw=10deg,limit_d
   * = 0.05m
   */
   ...
   */
  RM_INTERFACE_EXPORT void rm_algo_kin_set_singularity_thresholds(float limit_qe_algo,
                                                                  float limit_qw_algo,
                                                                  float limit_d_algo);
   ...
   */
  RM_INTERFACE_EXPORT void rm_algo_kin_get_singularity_thresholds(float *limit_qe_algo,
                                                                  float *limit_qw_algo,
                                                                  float *limit_d_algo);
   ...
   * @param q 要判断的关节角度,单位：°
   * @param distance
   * 输出参数，返回腕部中心点到肩部奇异平面的距离，该值越接近0说明越接近肩部奇异,单位m,不需要时可传NULL
   * @return 0表正常，-1表肩部奇异，-2表肘部奇异，-3表腕部奇异，-4仅支持6自由度机械臂
   */
  RM_INTERFACE_EXPORT int rm_algo_kin_robot_singularity_analyse(const float *const q,
                                                                float *distance);
  /**
   * @brief 设置工具包络球参数
   ...
   * @param data 工具包络球参数,注意其参数在末端法兰坐标系下描述
   */
  RM_INTERFACE_EXPORT void rm_algo_get_tool_envelope(const int toolSphere_i,
                                                     rm_tool_sphere_t *data);
  /**
   * @brief 自碰撞检测
   ...
   *（不设置则按照出厂默认的参数进行计算），此时机械臂控制句柄设置为NULL即可
   */
  RM_INTERFACE_EXPORT rm_pose_t rm_algo_forward_kinematics(rm_robot_handle *handle,
                                                           const float *const joint);
  /**
   * @brief 欧拉角转四元数
   *
   * @param eu 欧拉角
   ...
   */
  RM_INTERFACE_EXPORT rm_pose_t rm_algo_rotate_move(rm_robot_handle *handle,
                                                    const float *const curr_joint, int rotate_axis,
                                                    float rotate_angle, rm_pose_t choose_axis);
  /**
   * @brief 计算沿工具坐标系运动位姿
   *
   * @param handle 机械臂控制句柄
   ...
   */
  RM_INTERFACE_EXPORT rm_pose_t rm_algo_cartesian_tool(rm_robot_handle *handle,
                                                       const float *const curr_joint,
                                                       float move_lengthx, float move_lengthy,
                                                       float move_lengthz);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_trajectory_file_list(rm_robot_handle *handle, int page_num,
                                                      int page_size, const char *vague_search,
                                                      rm_trajectory_list_t *trajectory_list);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_set_run_trajectory(rm_robot_handle *handle,
                                                const char *trajectory_name);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_delete_trajectory_file(rm_robot_handle *handle,
                                                    const char *trajectory_name);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_save_trajectory_file(rm_robot_handle *handle,
                                                  const char *trajectory_name);
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_add_modbus_tcp_master(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_update_modbus_tcp_master(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_delete_modbus_tcp_master(rm_robot_handle *handle,
                                                      const char *master_name);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_modbus_tcp_master(rm_robot_handle *handle, const char *master_name,
                                                   rm_modbus_tcp_master_info_t *master);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_modbus_tcp_master_list(rm_robot_handle *handle, int page_num,
                                                        int page_size, const char *vague_search,
                                                        rm_modbus_tcp_master_list_t *list);
  /**
   * @brief 设置控制器RS485模式（四代控制器接口）
   * @param handle 机械臂控制句柄
   * @param controller_rs485_mode
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_set_controller_rs485_mode(rm_robot_handle *handle,
                                                       int controller_rs485_mode, int baudrate);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_controller_rs485_mode_v4(rm_robot_handle *handle,
                                                          int *controller_rs485_mode,
                                                          int *baudrate);
  /**
   * @brief 设置工具端RS485模式（四代控制器接口）
   * @param handle 机械臂控制句柄
   * @param mode
   * 通讯端口，0-设置工具端RS485端口为RTU主站，1-设置工具端RS485端口为灵巧手模式，2-设置工具端RS485端口为夹爪模式。
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_tool_rs485_mode_v4(rm_robot_handle *handle, int *tool_rs485_mode,
                                                    int *baudrate);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_rtu_coils(rm_robot_handle *handle,
                                                   rm_modbus_rtu_read_params_t param, int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_modbus_rtu_coils(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_rtu_input_status(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_rtu_holding_registers(rm_robot_handle *handle,
                                                               rm_modbus_rtu_read_params_t param,
                                                               int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_write_modbus_rtu_registers(rm_robot_handle *handle,
                                                        rm_modbus_rtu_write_params_t param);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_rtu_input_registers(rm_robot_handle *handle,
                                                             rm_modbus_rtu_read_params_t param,
                                                             int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_tcp_coils(rm_robot_handle *handle,
                                                   rm_modbus_tcp_read_params_t param, int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_write_modbus_tcp_coils(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_tcp_input_status(rm_robot_handle *handle,
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_tcp_holding_registers(rm_robot_handle *handle,
                                                               rm_modbus_tcp_read_params_t param,
                                                               int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_write_modbus_tcp_registers(rm_robot_handle *handle,
                                                        rm_modbus_tcp_write_params_t param);
  /**
   ...
   *            - -4: 三代控制器不支持该接口。
   */
  RM_INTERFACE_EXPORT int rm_read_modbus_tcp_input_registers(rm_robot_handle *handle,
                                                             rm_modbus_tcp_read_params_t param,
                                                             int *data);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_get_tool_action_list(rm_robot_handle *handle, int page_num,
                                                  int page_size, const char *vague_search,
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_save_tool_action(rm_robot_handle *handle, const char *action_name,
                                              int *selected_array, int array_size, int array_type);
  /**
   ...
   *            - -4: 三代控制器不支持该接口
   */
  RM_INTERFACE_EXPORT int rm_update_tool_action(rm_robot_handle *handle, const char *action_name,
                                                const char *new_name, int *selected_array,
                                                int array_size, int array_type);
  /**
   * @brief 设置避奇异模式
   *
   * @param handle 机械臂控制句柄
   ...
   * @param handle 机械臂控制句柄
   * @param cartesian_velocity 笛卡尔速度，单位：m/s，rad/s,
   线速度最大值：0.250m/s,角速度最大值：0.6rad/s
   * @param follow true-高跟随，false-低跟随。若使用高跟随，透传周期要求不超过 10ms。
   * @param trajectory_mode 高跟随模式下，0-完全透传模式、1-曲线拟合模式、2-滤波模式
   * @param radio
   trajectory_mode=0，完全透传模式：此为默认模式，将原始数据直接透传给关节，关节完全按照发送的轨迹进行支持。
   ...
   * @return int 函数执行的状态码。
              ...
              - -1: 数据发送失败，通信过程中出现问题。
   */
  RM_INTERFACE_EXPORT int rm_movev_canfd(rm_robot_handle *handle, float *cartesian_velocity,
                                         bool follow, int trajectory_mode, int radio);
  /**
   * @brief 笛卡尔速度透传初始化
   *
   * @param handle 机械臂控制句柄
   * @param avoid_singularity_flag	int	是否开启避奇异。1:开启；0:关闭.
   * @param frame_type	int
   参考坐标系选择。1：速度在工作坐标系下表示；0：速度在工具坐标系下表示。
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_movev_canfd_init(rm_robot_handle *handle,
                                                  int avoid_singularity_flag, int frame_type,
                                                  int dt);
  /**
   * @brief 读末端生态设备寄存器
   *
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_get_rm_plus_reg(rm_robot_handle *handle, int addr, int length,
                                             int *regarr);
   ...
   * @return int 函数执行的状态码。
              ...
              - -3: 返回值解析失败，接收到的数据格式不正确或不完整。
   */
  RM_INTERFACE_EXPORT int rm_set_rm_plus_reg(rm_robot_handle *handle, int addr, int length,
                                             int *data);
};
